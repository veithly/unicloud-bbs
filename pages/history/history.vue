<template>
	<view>
		<c-sticky>
			...
			<c-page-header title="历史记录"></c-page-header>
		</c-sticky>
		<unicloud-db v-slot="{data, loading, error, hasMore}" collection="history,posts" :where="`user_id=='${uid}'`" :field="field" ref="udb" orderby="create_date desc">
